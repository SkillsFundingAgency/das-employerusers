...
{
    public class WhenStartingRequestChangeEmail
    {
        ...
        {
            // Act
            var actual = await _orchestrator.StartRequestChangeEmail("NotMyClient", "http://unit.test");
        ...
        {
            // Act
            var actual = await _orchestrator.StartRequestChangeEmail("MyClient", returnUrl);
        ...
        {
            // Act
            var actual = await _orchestrator.StartRequestChangeEmail("MyClient", "http://unit.test");
